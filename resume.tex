...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Risk Analysis and Review Engine (RARE)}
        ...
        \item Spearheaded the initiative to on-board onto Snowflake, reducing data access time by 41\%. 
        \item Defined SLA and SLOs for our team's offerings. Setup Prometheus for monitoring the Kubernetes deployments.
...
\section{Extra Curricular Achievements}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem
    {Best Novice Speaker, Independent University Bangaldesh - Parliamentary Debate}{2019}
    \resumeSubItem
