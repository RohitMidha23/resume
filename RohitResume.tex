...
\section{Open Source Contributions}
  ...
  \resumeSubItem
  {Qiskit}{An open-source quantum computing framework for leveraging today's quantum processors in research, education, and business developed by IBM.}
\resumeSubHeadingListEnd
...
\section{Certifications}
  ...
  {Natural Language Processing with Tensorflow, deeplearning.ai}{July 2019}
        \resumeSubItem
  {Neural Networks and Deep Learning, deeplearning.ai}{Mar 2019}
      \resumeSubItem
